...
const OFFLINE_CACHE_FILES = [
     'http://localhost/wordpress/?amp=1',
];
...
const OFFLINE_PAGE = 'http://localhost/wordpress/?amp=1';
const NOT_FOUND_PAGE = 'http://localhost/wordpress/?amp=1';
