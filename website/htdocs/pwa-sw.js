const CACHE_VERSION = '1.7.22.2';

const BASE_CACHE_FILES = [
    'http://localhost/wordpress/wp-content/uploads/2020/10/logo.png',
'http://localhost/wordpress/wp-content/uploads/2020/10/logo.png',
'http://localhost/wordpress/2020/10/15/hello-world/',
'http://localhost/wordpress/2015/11/19/welcome-to-flatsome/',
'http://localhost/wordpress/2015/10/13/velkommen-til-bloggen-min/',
'http://localhost/wordpress/2015/10/13/a-simple-blog-post/',
'http://localhost/wordpress/2014/01/01/a-video-blog-post/',
...
const OFFLINE_PAGE = 'http://localhost/wordpress/';
const NOT_FOUND_PAGE = 'http://localhost/wordpress/';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('http://localhost/wordpress//wp-admin/');
//    },
];
